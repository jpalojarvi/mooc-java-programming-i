...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(bangorThreeBedroomApt.moreExpensiveThan(atlantaTwoBedroomApt)); // 195000 > 88000 true
        
        System.out.println(manhattanStudioApt.getSquares()*manhattanStudioApt.getPrincePerSquare()); // manhattan price
        System.out.println(bangorThreeBedroomApt.getSquares()*bangorThreeBedroomApt.getPrincePerSquare()); // bangor price
